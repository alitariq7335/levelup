...
const ContactPage: React.FC<ContactPageProps> = ({ currentPage, onNavigate }) => {
  return (
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-24 items-start">
          <div className="lg:sticky lg:top-40">
            <h3 className="text-blue-500 font-black uppercase text-[12px] mb-8">Comms Channel</h3>
            <h1 className="text-7xl md:text-[8rem] font-black tracking-tighter uppercase leading-[0.8] mb-12">
              OPEN AN <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-blue-600">UPLINK.</span>
            </h1>
            <p className="text-xl text-gray-400 font-light leading-relaxed mb-16 max-w-lg">
              Reach out with a message or give us a call. We’re ready to turn your idea into something epic.
            </p>

            <div className="space-y-16">
              <div className="group">
                <h4 className="text-blue-600 font-black text-[12px] uppercase mb-4 group-hover:tracking-[0.2em] transition-all">Central Hub</h4>
                <p className="text-3xl font-black uppercase tracking-tight">Sabzazar Lahore</p>
                {/* <p className="text-gray-500 mt-2 font-bold uppercase text-xs tracking-widest">Protocol Floor 04, Tech Plaza</p> */}
              </div>
              <div className="group">
                <h4 className="text-blue-600 font-black text-[12px] uppercase mb-4 group-hover:tracking-[0.2em] transition-all">Email</h4>
                <p className="text-3xl font-black uppercase tracking-tight">info@levelupsol.com.pk</p>
                {/* <p className="text-gray-500 mt-2 font-bold uppercase text-xs tracking-widest">Always Online // PKT / GMT / EST</p> */}
              </div>
              <div className="group">
                <h4 className="text-blue-600 font-black text-[12px] uppercase mb-4 group-hover:tracking-[0.2em] transition-all">Call Now</h4>
                <p className="text-3xl font-black uppercase tracking-tight">+92304-4896103</p>
                {/* <p className="text-gray-500 mt-2 font-bold uppercase text-xs tracking-widest">Always Online // PKT / GMT / EST</p> */}
              </div>
            </div>
            
            <div className="mt-20 pt-10 border-t border-white/5 flex items-center space-x-6">
               <span className="text-[12px] font-black tracking-widest text-gray-600 uppercase">Secure Link Status</span>
               <div className="w-2 h-2 bg-blue-600 rounded-full animate-pulse shadow-[0_0_10px_rgba(34,197,94,0.5)]"></div>
            </div>
          </div>
          ...
          <div className="glass p-10 md:p-16 rounded-[4rem] border-white/10 relative overflow-hidden group shadow-2xl">
            ...
            <form className="space-y-10 relative z-10">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <label className="text-[12px] font-black uppercase tracking-widest text-blue-500">Identifier</label>
                  <input 
                    type="text" 
                ...
                <div className="space-y-3">
                  <label className="text-[12px] font-black uppercase tracking-widest text-blue-500">Terminal Address</label>
                  <input 
                    type="email" 
                    className="w-full bg-white/5 border-b border-white/10 p-4 focus:border-blue-600 focus:outline-none transition-all placeholder:text-gray-700" 
              ...
              <div className="space-y-3">
                <label className="text-[12px] font-black uppercase tracking-widest text-blue-500">Operation Category</label>
              ...
              <div className="space-y-3">
                <label className="text-[12px] font-black uppercase tracking-widest text-blue-500">Encrypted Message</label>
                <textarea 
                  rows={4} 
              ...
              <button className="group-hover:text-black relative w-full py-8 bg-blue-600 rounded-[3rem] font-black uppercase text-xs overflow-hidden transition-all shadow-2xl cursor-pointer">
            ...
            <div className="mt-12 text-center text-[12px] font-bold text-gray-700 uppercase tracking-[0.3em]">
