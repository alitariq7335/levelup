...
const Vision: React.FC = () => {
    const services = [
        ...
        },
        {
            ...
            description: "Customized plans to maximize growth.",
        },
        {
            title: "Execution:",
            description: "Implementing campaigns across channels for optimal performance.",
        },
        {
            title: "Optimization:",
            description: "Continuous analysis to refine and enhance results.",
        },
        {
            title: "Reporting:",
            description: "Transparent insights to track your ROI.",
        },
    ];
