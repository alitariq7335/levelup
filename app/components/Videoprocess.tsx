...
import { motion } from "framer-motion";
  ...
  const editingProcess = [
    ...
    { step: "Review Footage", desc: "Selecting the best clips and moments",
      //  icon: "👀"
       },
    { step: "Rough Cut", desc: "Creating the initial edit structure",
      //  icon: "✂️"
       },
    { step: "Fine Tuning", desc: "Color grading, effects, and polish",
      //  icon: "🎨"
       },
    { step: "Sound Design", desc: "Music, SFX, and audio mixing",
      //  icon: "🔊"
       },
    { step: "Final Delivery", desc: "Export in all required formats",
      //  icon: "📦"
       }
  ];
                                ...
                                >
                                    ...
                                    <div className={`flex-1 ${index % 2 === 0 ? 'lg:text-right' : 'lg:text-left'}`}>
                                        <div className="bg-gradient-to-br from-[#1a1a2e] to-[#0f0f1e] rounded-2xl p-8 border border-blue-500/20 hover:border-blue-500/50 transition-all">
                                            <h4 className="text-2xl font-bold text-blue-400 mb-2">{step.step}</h4>
                                            <p className="text-white font-semibold mb-3">{step.desc}</p>
                                        </div>
                                    </div>
